...
<%@ page import="java.util.*,com.etl.etlmonitor.formbean.TestPageBean"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 <%
 List list = (List)request.getSession().getAttribute("list");  
 TestPageBean hb=(TestPageBean)list.get(0);
  %>
...
<!--Navigation end  -->
	<div id="page-wrapper" style="min-height: 413px;">
		<div class="container-fluid">
			<div class="row">
		    	<h4 class="page-header">添加测试page</h4>
		    	<form action="/etlTestMon/addPageAction" method="post" name="addForm">
		    	<input type="" name="pageid" id="pageid" value="<%=hb.getPageid() %>">
		    	<div class="table-responsive">
			        <table class="table table-striped table-bordered table-hover">
			            <thead>
			                <tr>
			                    <th>page描述(表名)</th><td><input type="text"  style="width: 500px" name="pagetitle" id="pagetitle" required="required" value="<%=hb.getPagetitle() %>"></td>
			                </tr>
			                <tr>
			                    <th>备注</th><td><textarea rows="3" cols="80" name="content" required="required" ><%=hb.getContent() %></textarea></td>
			                </tr>		                
			                <tr>
			                    <th>提交人</th><td><input type="text" name="auther" id="auther" required="required" value="<%=hb.getAuther() %>"></td>
			                </tr>
			                 <tr>
