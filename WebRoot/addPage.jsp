...
function add(){  
		document.addForm.action="/etlTestMon/addPageAction";  
			...
			<div class="row">
		    	...
		    	<div class="table-responsive">
			        <table class="table table-striped table-bordered table-hover">
			            <thead>
			                <tr>
			                    <th>page描述(表名)</th><td><input type="text"  style="width: 500px" name="pagetitle" id="pagetitle" required="required" ></td>
			                </tr>
			                <tr>
			                    <th>备注</th><td><textarea rows="3" cols="80" name="content" required="required" ></textarea></td>
			                </tr>		                
			                <tr>
